...
???
350 vs. 219.5 - _p_ = .007983 . Not plotted other and clinical
...
???
Student samples have a more pronounced difference.
...
* Low power to detect 'small' effect sizes: 52.99% and 33.25%.

???
Robustness checks needed. 107 were between-subject CHANGE
...
* Very low power to detect 'small' effect sizes: 21.96% and 14.40%. 
