...
* The weighted mean BMI by sample size for women (_M_ = 24.41, _SD_ = 5.27) was significantly lower than that for men (_M_ = 26.27, _SD_ = 5.95, _t_(62452) = 46.73, _p_ < .0001, _d_ = 0.312).
...
* Very good power to detect 'medium' theoretical and observed effect sizes: 99.89% and 95.04%, respectively. 
...
* Simulations suggest that "general population" samples differ from the overall population in age and sometimes also BMI.

--

* Simulations suggest that student samples differ from age matched population samples in BMI.
